widget = {
	...
	onData: function (el, data) {
		...
		var summaryElement = $("#summary_ADL");
		var errorElement = $("#error_ADL");
		var timeElement = $("#time_ADL");
		var chartElement = $("#chart_ADL");
		chartElement.html("");
		chartElement.append($('<canvas id="canvas_ADL" class="canvas"/>'));
		var canvasElement = document.getElementById("canvas_ADL");
		var table1 = document.getElementById("table1_ADL");
		var table2 = document.getElementById("table2_ADL");
		table1.innerHTML = ''
		table2.innerHTML = ''
