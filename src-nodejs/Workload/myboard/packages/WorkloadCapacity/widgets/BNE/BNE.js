widget = {
	...
	onData: function (el, data) {
		...
		var summaryElement = $("#summary_BNE");
		var errorElement = $("#error_BNE");
		var timeElement = $("#time_BNE");
		var chartElement = $("#chart_BNE");
		chartElement.html("");
		chartElement.append($('<canvas id="canvas_BNE" class="canvas"/>'));
		var canvasElement = document.getElementById("canvas_BNE");
		var table1 = document.getElementById("table1_BNE");
		var table2 = document.getElementById("table2_BNE");
		table1.innerHTML = ''
		table2.innerHTML = ''
