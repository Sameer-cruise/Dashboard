widget = {
	...
	onData: function (el, data) {
		...
		var summaryElement = $("#summary_MEL");
		var errorElement = $("#error_MEL");
		var timeElement = $("#time_MEL");
		var chartElement = $("#chart_MEL");
		chartElement.html("");
		chartElement.append($('<canvas id="canvas_MEL" class="canvas"/>'));
		var canvasElement = document.getElementById("canvas_MEL");
		var table1 = document.getElementById("table1_MEL");
		var table2 = document.getElementById("table2_MEL");
		table1.innerHTML = ''
		table2.innerHTML = ''
			...
			Chart.helpers.extend(Chart.controllers.line.prototype, {
				draw: function () {
					...
					for (var i = 0; i < data.length; i++) {
						/*if(i%2==1){
							ctx.datasets[0].points[4].fillColor = "rgba(84, 120, 228, 1)" ;
