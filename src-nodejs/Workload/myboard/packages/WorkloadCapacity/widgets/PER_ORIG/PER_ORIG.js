widget = {
	...
	onData: function (el, data) {
		...
		var summaryElement = $("#summary_PER");
		var errorElement = $("#error_PER");
		var timeElement = $("#time_PER");
		var chartElement = $("#chart_PER");
		chartElement.html("");
		chartElement.append($('<canvas id="canvas_PER" class="canvas"/>'));
		var canvasElement = document.getElementById("canvas_PER");
		var table1 = document.getElementById("table1_PER");
		var table2 = document.getElementById("table2_PER");
		table1.innerHTML = ''
		table2.innerHTML = ''
