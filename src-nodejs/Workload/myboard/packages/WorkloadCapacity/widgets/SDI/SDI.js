widget = {
	...
	onData: function (el, data) {
		...
		var summaryElement = $("#summary_SDI");
		var errorElement = $("#error_SDI");
		var timeElement = $("#time_SDI");
		var chartElement = $("#chart_SDI");
		chartElement.html("");
		chartElement.append($('<canvas id="canvas_SDI" class="canvas"/>'));
		var canvasElement = document.getElementById("canvas_SDI");
		var table1 = document.getElementById("table1_SDI");
		var table2 = document.getElementById("table2_SDI");
		table1.innerHTML = ''
		table2.innerHTML = ''
