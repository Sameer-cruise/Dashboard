widget = {
	...
	onData: function (el, data) {
		...
		var summaryElement = $("#summary_SDO");
		var errorElement = $("#error_SDO");
		var timeElement = $("#time_SDO");
		var chartElement = $("#chart_SDO");
		chartElement.html("");
		chartElement.append($('<canvas id="canvas_SDO" class="canvas"/>'));
		var canvasElement = document.getElementById("canvas_SDO");
		var table1 = document.getElementById("table1_SDO");
		var table2 = document.getElementById("table2_SDO");
		table1.innerHTML = ''
		table2.innerHTML = ''
